...
# -*- coding: utf-8 -*-
"""
Created on Thu May 16 16:25:26 2019
...
conn = mysql.connector.connect(user='hbagaria', password='12345678',
                              host='db4free.net', database = 'hbagariadb')
